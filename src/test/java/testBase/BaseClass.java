...
public class BaseClass  {
	...
	public void Setup(String os, String br) throws IOException {
		...
		// Reading data from properties file 
		 ...
		 String url =propertiesobj.getProperty("appurl1"); // reading url from properties file
	...
	public String randomAlphanumber() {
		...
		String generatedStrings=RandomStringUtils.secure().nextAlphabetic(5);
		String generatednum=RandomStringUtils.secure().nextNumeric(3);
		return (generatedStrings+generatednum);		
	}
	// ============================
	// Capture Screenshot
	// ============================
	public String captureScreen(String tname) throws IOException {
	    ...
	    String timeStamp = new SimpleDateFormat("yyyyMMddhhmms").format(new Date());
